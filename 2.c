...
void map_explanation(void)                             //이론 배경화면
{
    int i;
...
void map_practice(void)                                   //퀴즈 배경화면
{
    int i;
...
void map_chapter2_p(void)                                //2과퀴즈  배경화면
{
    int i;
...
void map_chapter4_p(void)                          //4과 문제 배경화면
{
    int i;
